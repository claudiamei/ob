...
angular.module('amelia.docs.controllers').controller('obAreaGraphControllerDemo', ['$scope',
  function($scope) {
    $scope.data = [{
      name: 'TestPub1',
      values: [{
...
angular.module('amelia.docs.controllers').controller('obAreaGraphAxisControllerDemo', ['$scope', '$interval',
