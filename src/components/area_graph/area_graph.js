  ...
  return function(options) {
    ...
    var defaults = {
      ...
      parseDate: function(d) {
        return d3.time.format("%m/%d/%Y").parse(d.date);
      },
...
.directive('obAreaGraph', ['$parse', '$window', 'd3Service', 'OBAreaGraphConfig', 'debounce',
  function($parse, $window, $compile, OBAreaGraphConfig, debounce) {
    return {
      restrict: 'EA',
      scope: {
        data: '=',
      ...
      link: function(scope, element, attrs) {
        ...
        scope.create = function(data) {
          ...
          legendContent.append('div')
            ...
            .text(function(d) {
              return yAxisFormat(d.values[0].value);
            });
